...
data class CoordinatorModel(var coordi_idx: Int, var coordi_user_idx: Int, var coordi_name: String, var coordi_intro_text: String,
    ...
    var coordi_business_license : String, var coordi_mbti: String, var coordi_business_phone: String, var coordi_forwarding_loc: String,
    ...
    var coordi_request_date: String) {
