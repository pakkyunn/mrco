 ...
 * Use the [CodiProductInfoAccessoryFragment.newInstance] factory method to
...
class CodiProductInfoAccessoryFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CodiProductInfoAccessoryFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CodiProductInfoAccessoryFragment().apply {
