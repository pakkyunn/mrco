...
class MainActivity : AppCompatActivity() {
    ...
    fun replaceFragment(name:MainFragmentName, addToBackStack:Boolean, isAnimate:Boolean, data:Bundle?){
        ...
        when(name){
            ...
            MainFragmentName.MODIFY_USER_FRAGMENT -> {
                newFragment = ModifyUserFragment()
            }
            MainFragmentName.JOIN_COORDINATOR_FRAGMENT -> {
                newFragment = JoinCoordinatorFragment()
            }
            MainFragmentName.JOIN_COORDINATOR_NEXT_FRAGMENT -> {
                newFragment = JoinCoordinatorNextFragment()
            }
            MainFragmentName.MODIFY_COORDINATOR_FRAGMENT -> {
                newFragment = ModifyCoordinatorFragment()
            }
