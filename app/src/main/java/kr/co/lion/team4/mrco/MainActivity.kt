...
class MainActivity : AppCompatActivity() {
    ...
    fun replaceFragment(
        ...
        when (name) {
            ...
            MainFragmentName.JOIN_COORDINATOR_NEXT_FRAGMENT -> newFragment =
                JoinCoordinatorNextFragment()

            // 회원 정보 수정 (사용자, 코디네이터)
            MainFragmentName.MODIFY_USER_FRAGMENT -> newFragment = ModifyUserFragment()
            MainFragmentName.MODIFY_COORDINATOR_FRAGMENT -> newFragment =
                ModifyCoordinatorFragment()
            ...
            MainFragmentName.COORDINATOR_MYPAGE_FRAGMENT -> newFragment =
                CoordinatorMyPageFragment()
            ...
            // 상품 1:1문의 작성화면
            MainFragmentName.REGISTER_PRODUCT_QNA_FRAGMENT -> newFragment =
                RegisterProductQnaFragment()
            ...
            // 상품 문의 답변 등록 화면
            MainFragmentName.REGISTER_QNA_ANSWER_FRAGMENT -> newFragment =
                RegisterQnaAnswerFragment()

            // 판매자 - 코디 상품등록 화면
            MainFragmentName.ADD_PRODUCT_FRAGMENT -> newFragment = AddProductFragment()

            // 판매자 - 등록상품 관리
            MainFragmentName.FRAGMENT_PRODUCT_MANAGEMENT -> newFragment =
                ProductManagementFragment()

            // 코디 상품 관리, 개별 상품 관리 탭
            MainFragmentName.FRAGMENT_CODI_PRODUCT_MANAGEMENT -> newFragment =
                CodiProductMangementFragment()

            MainFragmentName.FRAGMENT_INDIVIDUAL_PRODUCT_MANAGEMENT -> newFragment =
                IndividualProductManagementFragment()

            // 코디 상품 관리 - 상세
            MainFragmentName.FRAGMENT_CODI_PRODUCT_INFO -> newFragment = CodiProductInfoFragment()
            MainFragmentName.FRAGMENT_CODI_PRODUCT_INFO_ALL -> newFragment =
                CodiProductInfoAllFragment()

            MainFragmentName.FRAGMENT_CODI_PRODUCT_INFO_TOP -> newFragment =
                CodiProductInfoTopFragment()

            MainFragmentName.FRAGMENT_CODI_PRODUCT_INFO_BOTTOM -> newFragment =
                CodiProductInfoBottomFragment()

            MainFragmentName.FRAGMENT_CODI_PRODUCT_INFO_SHOES -> newFragment =
                CodiProductInfoShoesFragment()

            MainFragmentName.FRAGMENT_CODI_PRODUCT_INFO_ACCESSORY -> newFragment =
                CodiProductInfoAccessoryFragment()

            // 개별 상품 관리 - 상세
            MainFragmentName.FRAGMENT_INDIVIDUAL_PRODUCT_INFO -> newFragment =
                IndividualProductInfoFragment()
