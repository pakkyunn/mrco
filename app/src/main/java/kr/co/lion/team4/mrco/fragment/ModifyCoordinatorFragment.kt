...
//        val coordinatorAddressDetail = modifyCoordinatorViewModel.textFieldModifyCoordinatorAddressDetail.value!!
        ...
        // originalCoordinatorModel 수정한 modifiedCoordinatorModel 담는다.
...
//CoordinatorModel(var coordi_idx: Int, var coordi_user_idx: Int, var coordi_name: String,
// var coordi_intro_text: String, var coordi_photo: String, var coordi_license: String,
// var coordi_license_num: String, var coordi_portfolio: String,
// var coordi_business_license : String, var coordi_mbti: String, var coordi_business_phone: String,
// var coordi_forwarding_loc: String, var coordi_return_loc: String, var coordi_bank: String,
// var coordi_account_holder: String, var coordi_account: String, var coordi_followers: Int,
// var coordi_permission: Boolean, var coordi_request_date: String) {
